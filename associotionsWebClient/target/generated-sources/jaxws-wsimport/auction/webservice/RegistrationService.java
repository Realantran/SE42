 ...
 * 
 */
@WebServiceClient(name = "RegistrationService", targetNamespace = "http://webservice.auction/", wsdlLocation = "http://localhost:8100/Registration?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8100/Registration?wsdl");
